...
def create_app(
        ...
        energy_consumption_profile, solar_profile, cum_d, t, v_avg
    ):
...
if __name__ == '__main__':
    ...
    output = pd.read_csv("raw_run_dat.csv").fillna(0)
    ...
    app = create_app(
        ...
        energy_consumption_profile, solar_profile, cum_d, t_end / 3600, v_avg
    )
